...
tokaido_stations = [
    ...
    # ============================ R1/9/20 ============================
    [Kyoto, Shin_Osaka, Osaka, Umeda, Shinsaibashi, Namba, Dobutsuen_Mae, Tennoji, Tanimachi_4_Chome, Temmabashi, Higashi_Umeda, Osaka, Sannomiya, Kobe],
    # ============================ R1/9/21 ============================
    [Kobe, Sannomiya, Kyukyoryuchi_Daimarumae, Minato_Motomachi, Harborland, Kobe, Sannomiya, Osaka, Shin_Osaka, Tokyo, Chiba]
]
