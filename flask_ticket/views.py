...
def slideShow_view():
    images = ["東北一周旅行(東北・羽越)",
              [# =================================================
               ...
               # --------------------------------------
               ["R7/2/25", "12_千葉県/駅名標_千葉駅_総武本線.jpg", "千葉駅 駅名標"],
               ["R7/2/25", "../trainCar/12_千葉県/千葉駅_E217系.jpg", "総武快速線 千葉駅-->東京駅"],
               ["R7/2/25", "13_東京都/駅名標_東京駅_在来線_地下ホーム.jpg", "東京駅 駅名標(在来線)"],
               # --------------------------------------
               ["R7/2/25", "13_東京都/駅名標_東京駅_東北新幹線.jpg", "東京駅 駅名標(新幹線)"],
               ["R7/2/25", "../trainCar/13_東京都/東京駅_E5系.jpg", "東北新幹線 東京駅-->郡山駅"],
               ["R7/2/25", "07_福島県/駅名標_郡山駅_新幹線.jpg", "郡山駅 駅名標(新幹線)"],
               # --------------------------------------
               ["R7/2/25", "07_福島県/駅名標_郡山駅_在来線.jpg", "郡山駅 駅名標(在来線)"],
               ["R7/2/25", "../trainCar/07_福島県/郡山駅_E721系.jpg", "磐越西線 郡山駅-->会津若松駅"],
               ["R7/2/25", "07_福島県/駅名標_会津若松駅.jpg", "会津若松駅 駅名標"],
               # =================================================
               ...
               # --------------------------------------
               ["R7/2/25", "07_福島県/駅名標_七日町駅.jpg", "七日町駅 駅名標"],
               ["R7/2/25", "../trainCar/07_福島県/七日町駅_AT-550形.jpg", "会津鉄道 七日町駅-->会津若松駅"],
               ["R7/2/25", "07_福島県/駅名標_会津若松駅.jpg", "会津若松駅 駅名標"],
               ["R7/2/25", "../trainCar/07_福島県/会津若松駅_E721系.jpg", "磐越西線 会津若松駅-->郡山駅"],
               ...
               # --------------------------------------
               ["R7/2/25", "07_福島県/駅名標_郡山駅_新幹線.jpg", "郡山駅 駅名標(新幹線)"],
               ["R7/2/25", "../trainCar/07_福島県/郡山駅_E5系.jpg", "東北新幹線 郡山駅-->福島駅"],
               ["R7/2/25", "07_福島県/駅名標_福島駅_新幹線.jpg", "福島駅 駅名標(新幹線)"],
               # =================================================
               ["R7/2/25", "07_福島県/駅舎_福島駅.jpg", "福島駅 駅舎"],
               # --------------------------------------
               ["R7/2/25", "07_福島県/駅名標_福島駅_新幹線.jpg", "福島駅 駅名標(新幹線)"],
               ["R7/2/25", "../trainCar/04_宮城県/仙台駅_E5系.jpg", "東北新幹線 福島駅-->仙台駅"],
               ["R7/2/25", "04_宮城県/駅名標_仙台駅_新幹線.jpg", "仙台駅 駅名標(新幹線)"],
               # =================================================
               ["R7/2/25", "04_宮城県/駅舎_仙台駅_昼.jpg", "仙台駅 駅舎"],
               ["R7/2/25", "04_宮城県/AER展望テラス.jpg", "AER展望テラス"],
               # --------------------------------------
               ["R7/2/25", "04_宮城県/駅名標_仙台駅_新幹線.jpg", "仙台駅 駅名標(新幹線)"],
               ["R7/2/25", "../trainCar/04_宮城県/仙台駅_E5系.jpg", "東北新幹線 仙台駅-->新青森駅"],
               ["R7/2/25", "02_青森県/駅名標_新青森駅_新幹線.jpg", "新青森駅 駅名標(新幹線)"],
               # --------------------------------------
               ["R7/2/25", "02_青森県/駅名標_新青森駅_在来線.jpg", "新青森駅 駅名標(在来線)"],
               ["R7/2/25", "../trainCar/02_青森県/青森駅_E701系.jpg", "奥羽本線 新青森駅-->青森駅"],
               ["R7/2/25", "02_青森県/駅名標_青森駅.jpg", "青森駅 駅名標"],
               # =================================================
               ["R7/2/25", "02_青森県/駅舎_青森駅.jpg", "青森駅 駅舎"],
               ["R7/2/25", "02_青森県/青森駅_青森ベイブリッジ.jpg", "青森駅 青森ベイブリッジ"],
               # --------------------------------------
               ["R7/2/25", "02_青森県/駅名標_青森駅.jpg", "青森駅 駅名標"],
               ["R7/2/25", "../trainCar/02_青森県/青森駅_E701系.jpg", "奥羽本線 青森駅-->新青森駅"],
               ["R7/2/25", "02_青森県/駅名標_新青森駅_在来線.jpg", "新青森駅 駅名標(在来線)"],
               # =================================================
               ...
               # --------------------------------------
               ["R7/2/25", "02_青森県/駅名標_新青森駅_新幹線.jpg", "新青森駅 駅名標(新幹線)"],
               ["R7/2/25", "../trainCar/02_青森県/新青森駅_E5系.jpg", "東北新幹線 新青森駅-->盛岡駅"],
               ["R7/2/25", "03_岩手県/駅名標_盛岡駅_東北新幹線.jpg", "盛岡駅 駅名標(新幹線)"],
               # =================================================
               ["R7/2/25", "03_岩手県/駅舎_盛岡駅.jpg", "盛岡駅 駅舎"],
               # --------------------------------------
               ["R7/2/26", "03_岩手県/駅名標_盛岡駅_秋田新幹線.jpg", "盛岡駅 駅名標(新幹線)"],
               ["R7/2/26", "../trainCar/03_岩手県/盛岡駅_E6系.jpg", "東北新幹線 盛岡駅-->角館駅"],
               ["R7/2/26", "05_秋田県/駅名標_角館駅.jpg", "角館駅 駅名標"],
               # =================================================
               ...
               # --------------------------------------
               ["R7/2/26", "05_秋田県/駅名標_角館駅.jpg", "角館駅 駅名標"],
               ["R7/2/26", "../trainCar/05_秋田県/角館駅_E6系.jpg", "秋田新幹線 角館駅-->秋田駅"],
               ["R7/2/26", "05_秋田県/駅名標_秋田駅_新幹線.jpg", "秋田駅 駅名標(新幹線)"],
               # =================================================
               ["R7/2/26", "05_秋田県/駅舎_秋田駅.jpg", "秋田駅 駅舎"],
               # --------------------------------------
               ["R7/2/26", "05_秋田県/駅名標_秋田駅_在来線.jpg", "秋田駅 駅名標(在来線)"],
               ["R7/2/26", "../trainCar/05_秋田県/秋田駅_E653系.jpg", "羽越本線 秋田駅-->酒田駅"],
               ["R7/2/26", "06_山形県/駅名標_酒田駅.jpg", "酒田駅 駅名標"],
               # =================================================
               ...
               # --------------------------------------
               ["R7/2/26", "06_山形県/駅名標_酒田駅.jpg", "酒田駅 駅名標"],
               ["R7/2/26", "../trainCar/06_山形県/酒田駅_E653系.jpg", "羽越本線 酒田駅-->新発田駅"],
               ["R7/2/26", "15_新潟県/笹川流れ.jpg", "笹川流れ"],
               ["R7/2/26", "15_新潟県/駅名標_新発田駅.jpg", "新発田駅 駅名標"],
               # =================================================
               ["R7/2/26", "15_新潟県/駅舎_新発田駅.jpg", "新発田駅 駅舎"],
               ["R7/2/26", "15_新潟県/新発田城.jpg", "新発田城"],
               # --------------------------------------
               ["R7/2/26", "15_新潟県/駅名標_新発田駅.jpg", "新発田駅 駅名標"],
               ["R7/2/26", "../trainCar/15_新潟県/新発田駅_E653系.jpg", "白新線 新発田駅-->新潟駅"],
               ["R7/2/26", "15_新潟県/駅名標_新潟駅_在来線.jpg", "新潟駅 駅名標(在来線)"],
               # =================================================
               ["R7/2/26", "15_新潟県/駅舎_新潟駅.jpg", "新潟駅 駅舎"],
               # --------------------------------------
               ["R7/2/26", "15_新潟県/駅名標_新潟駅_新幹線.jpg", "新潟駅 駅名標(新幹線)"],
               ["R7/2/26", "../trainCar/15_新潟県/新潟駅_E7系.jpg", "上越新幹線 新潟駅-->東京駅"],
               ["R7/2/26", "13_東京都/駅名標_東京駅_東北新幹線.jpg", "東京駅 駅名標(新幹線)"],
               # --------------------------------------
               ["R7/2/26", "13_東京都/駅名標_東京駅_在来線_地下ホーム.jpg", "東京駅 駅名標(在来線)"],
               ["R7/2/26", "../trainCar/13_東京都/東京駅_E217系.jpg", "総武快速線 東京駅-->千葉駅"],
               ["R7/2/26", "12_千葉県/駅名標_千葉駅_総武本線.jpg", "千葉駅 駅名標"],
               # =================================================
